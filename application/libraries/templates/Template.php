...
abstract class Template
{
     ...
     */
    public function collectCss($local_css = array())
    {
        $coulomb_css_arr = array_values($this->CI->config->item('css_default'));
    ...
    {
        $coulomb_js_arr = array_values($this->CI->config->item('js_default'));
